...
# ╔═╡ 4da983bc-a709-4a75-a7b8-97a4601c2b4b
begin
	using PlutoUI
...
Julia is fast/great because of a set of features that work well together.  There's no magic dust you can go sprinkle on your language of choice.
...
##### 1. Julia solves the two-language problem:
  - Write **prototype** code in *easy* language.
  - Write **production** code in *fast* language.
"""

# ╔═╡ 7bd8395c-1407-49b3-b334-5cae48cd8132
md"[Julia Microbenchmarks](https://julialang.org/benchmarks/):"
...
md"##### 2. Julia helps bridge the gap in the two-culture problem:"
...
md"""
##### 3. Multiple Dispatch & JIT Compilation
"""

# ╔═╡ 1450aeb6-7f32-4fe9-bb47-8116ecae290f
md"""
- Preliminary: [Sapir-Worf Hypothesis](https://en.wikipedia.org/wiki/Linguistic_relativity)
...
md"""
- Example: [https://heyjoshday.com/blog/2018-08-17-why-i-use-julia/](https://heyjoshday.com/blog/2018-08-17-why-i-use-julia/)
"""

# ╔═╡ e6646f6b-71a5-419a-a433-0ffb9c814c67
md"""
## Julia Resources

- Official Docs: [https://docs.julialang.org/en/](https://docs.julialang.org/en/)
- Finding Packages: [JuliaHub](https://juliahub.com/ui/Home)
- Asking Questions:
  - [Discourse](https://discourse.julialang.org)
  - [Slack](http://julialang.slack.com/)
"""

# ╔═╡ d140d9ae-16f2-4469-87a9-8d77860ba32a
@bind x Slider(1:10)

# ╔═╡ d474f7da-cf94-403f-8933-cafcaacb28ea
sum(1:x)

# ╔═╡ 5ca09de9-9223-4ddb-ad3c-5987535d4574
y = 5

# ╔═╡ 6a2092a7-2005-474a-8dba-362a8121f734
y + x
