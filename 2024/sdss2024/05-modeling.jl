...
# ╔═╡ 95ec7687-b7e9-414d-917d-67ff994586a4
using StatsModels

# ╔═╡ 85aa3ce1-7810-4f55-8c6a-1e1919137cd9
using MLJ
...
!!! note "Less Built-In to Base Julia"
	Again, Julia has less things built into the base language for statistics than R.  Here we'll cover the core packages to fitting statistical models in Julia.
"""

# ╔═╡ d57682f6-cc57-41f3-9c76-37b8f651aa59
md"""
## Statistical Modeling Formulas

- [StatsModels](https://github.com/JuliaStats/StatsModels.jl) provides the formula notation for specifying models.

!!! note "Formulas Must be a Macro"
	Why?  Because we are using the expression e.g. `y ~ 1 + x`.

	There are several packages similar to StatsModels that provide mini-languages/[domain-specific languages (DSLs)](https://en.wikipedia.org/wiki/Domain-specific_language) in Julia.  Macros are how you would give *different meaning* to *otherwise meaningful* Julia syntax.  E.g. `1 + x` already has meaning in Julia, but we need this to mean add an intercept and a main effect for variable `x`.
"""

# ╔═╡ 3b5981bb-b1fd-4a53-9925-270c4c2c6672


# ╔═╡ c5ab58a3-9bc6-4ec2-ba50-b668aa6bb5e9
md"""
...
# ╔═╡ 9a8900bc-3fcc-41fd-b531-2c8971c4c7db


# ╔═╡ efe88188-7fe4-4db7-a2dd-697734c2bba3
md"""
## Machine Learning
...
!!! note "About MLJ"
	MLJ is an ambitious project/ecosystem that attempts to consolidate all of the different machine learning packages in Julia under a unified interface.  In a sense it is the Julia equivalent of Python's scikit-learn or R's mlr.
"""
...
manifest_format = "2.0"
project_hash = "be79f5e9c9f53877aa845a8e5c88375af3673178"
