...
# ╔═╡ 4076f3e5-55f4-4a46-97fc-541c666270ec
md"""
# FileTrees.jl

- Think `mapreduce` for files.
  - `map` a function to each file (e.g. read as `DataFrame` and perform a calculation)
  - `reduce` mapped function to a single result.
"""

# ╔═╡ 9bd90eaa-d1a4-4eea-a84e-99d0d41b6721
stocks_path = "/Users/joshday/datasets/kaggle_stock_market/Stocks/"

# ╔═╡ 11243c73-e29a-47c5-86f1-e05299740211
tree = FileTree(stocks_path);

# ╔═╡ 4ace243a-4a62-49fc-9aac-7cb05199b858
md"## Subsets of a Tree"
...
# ╔═╡ e2b4512b-275e-488a-b128-e7c740a45a86
stock_dfs_lazy = FileTrees.load(tree, lazy=be_lazy) do file
...
# ╔═╡ 6cf536c6-39de-4b8e-8c0e-51afff3bc666
...
# ╔═╡ 258a335d-b945-4cdd-8ad9-efe3a00b5642
bar(stocklist, [stocks_lazy_reduce_exec["$s.us.txt"] for s in stocklist])
